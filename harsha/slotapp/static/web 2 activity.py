...
<body>
    ...
    <div id="about" class="container py-5">
        <h2>About Us</h2>
        <p>PharmaCare is dedicated to providing high-quality medicines and healthcare products to improve the well-being of our customers.</p>
    </div>
    ...
    <footer class="bg-light text-center py-3">
        <p>Designed and Developed by N. ABIRAMI</p>
    </footer>
